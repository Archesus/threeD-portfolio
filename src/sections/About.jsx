...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('ak0375451@gmail.com');
            ...
            <div className='grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full' id='about'>
                <div className='col-span-1 xl:row-span-3'>
                    <div className='grid-container'>
                        ...
                        <div>
                            <p className='grid-headtext'>Hi, I'm Anurag</p>
                            <p className='grid-subtext'>I'm a designer and developer crafting intuitive, beautiful digital experiences with creativity and code.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='col-span-1 xl:row-span-3'>
                    <div className='grid-container'>
                        ...
                        <div>
                            ...
                            <p className='grid-subtext'>I specialize in Javacsript/Typescript with a focus on React and Next JS ecosystem.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='col-span-1 xl:row-span-4'>
                    <div className='grid-container'>
                        ...
                        <div>
                            ...
                            <a href='https://www.linkedin.com/in/anurag-kumar-301243269' target="_blank" rel="noopener noreferrer">
                ...
                <div className='xl:col-span-2 xl:row-span-3'>
                    <div className='grid-container'>
                        ...
                        <div>
                            ...
                            <p className='grid-subtext'>I love designing and building things through coding. Coding isn't just my proffesion - its my passion.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='grid-container'>
                        ...
                        <div className='space-y-2'>
                            ...
                            <div className="copy-container" onClick={handleCopy}>
                                ...
                                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">ak0375451@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
